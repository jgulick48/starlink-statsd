...
// 	protoc        v3.6.1
// source: github.com/jgulick48/starlink-statsd/pkg/spacex.com/api/device/dish.proto

package device

import (
	network "github.com/jgulick48/starlink-statsd/pkg/spacex.com/api/satellites/network"
...
func (x *DishGetStatusResponse) GetDisablementCode() network.UtDisablementCode {
	...
	return network.UtDisablementCode_UNKNOWN_STATE
}
...
var file_spacex_api_device_dish_proto_goTypes = []interface{}{
	...
	(network.UtDisablementCode)(0),        // 33: SpaceX.API.Satellites.Network.UtDisablementCode
